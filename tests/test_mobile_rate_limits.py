...
def test_mobile_state_hmac_domain_set_is_closed_and_every_digest_is_distinct():
    ...
    expected = {
        ...
        "step-up-start-selector-rate",
        "step-up-start-user-rate",
        "step-up-start-client-ip",
        "step-up-exchange-user-rate",
        "step-up-exchange-client-ip",
        "step-up-email-code-verifier",
