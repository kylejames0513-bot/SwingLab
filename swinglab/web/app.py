...
def create_app(
    ...
    *,
    ...
    error_page = (
        ...
        "place-items:center;background:#f2f2f3;color:#1d1f20;"
        ...
        f"letter-spacing:.16em;text-transform:uppercase;color:#375169;\">"
        f"{brand_name}</p>"
        "<h1 style=\"margin:0 0 12px;font-size:clamp(26px,5vw,34px);"
        "font-weight:700;letter-spacing:-.02em;color:#1d1f20;\">"
        "Something went wrong on our side.</h1>"
        "<p style=\"margin:0 0 24px;line-height:1.6;color:#5d5d60;\">"
        ...
        "border-radius:0;background:#2c455d;color:#f2f2f3;"
